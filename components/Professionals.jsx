  ...
  return (
    ...
    <div className={styles.container}>
      <div className={styles.box}>
        <Image className={styles.image} src="/pone.png" alt="Image 1" width={500} height={500} />
      ...
      <div className={styles.box}>
        <Image className={styles.image} src="/ptwo.png" alt="Image 2" width={500} height={500} />
      ...
      <div className={styles.box}>
        <Image className={styles.image} src="/pthree.png" alt="Image 3" width={500} height={500} />
      ...
      <div className={styles.box}>
        <Image className={styles.image} src="/Mfour.png" alt="Image 4" width={500} height={500} />
