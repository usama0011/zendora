            ...
            <div className={styles.singleApplicationContainer}>
                ...
                <div className={`${styles.sidebar} ${sidebarOpen ? styles.sidebarOpen : ''}`}>
                    ...
                    <ul className={styles.sidebarList}>
                        ...
                        <li className={`${styles.sidebarItem} ${router.pathname === '/admin/createpost' ? styles.activeRoute : ''}`}>
                            <PencilSquareIcon className={styles.userIcon} />
                            <Link href="/admin/createpost">Create a Post</Link>
                        </li>
